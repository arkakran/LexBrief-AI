...
#         # Current collection name (will be set per document)
...
#                 # Collection exists - delete it for fresh analysis
...
#             # Sort by name (timestamp is in doc_id) and delete oldest
...
#         #Retrieve chunks using multiple query formulations
